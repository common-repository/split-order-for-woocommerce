...
if (!class_exists('wos_split_according_class')) {

    class wos_split_according_class {
        ...
        public function frontend_variation() {
            ...
            //add_filter('woocommerce_before_checkout_form', array($this, 'remove_product_from_Cart'));
        }
        ...
        public function change_total_on_checking($order_id) {
            ...
            foreach ($items as $item => $valData) {
                if (in_array($valData['variation'][$attributeKey], $selectAttribute)) {
                    $arrVal[$valData['variation'][$attributeKey]][] = $valData;
                } else {
                    $arrPro[] = $valData;
                }
            }
